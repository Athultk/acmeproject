...
''' 
The task ID in the task file is not in the correct format and hence the same need to be changed
'''
...
formatted_tasks_file_path = os.path.join(scripts_dir, '..', 'data', 'formatted', 'tasks_formatted.xlsx')
